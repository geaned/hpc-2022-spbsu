...
С помощью параметра гранулярности можно отдельно задать, из диапалонов какого размера будут формироваться отдельные задачи, которые будут отправляться в пул потоков.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkyNjAzOTUzOF19
-->